...
export class BallotService {
  ...
  async validateVotePayload(
    ...
    if (electionType === 'PRESIDENTIAL') {
      const { candidateId } = vote as unknown as PresidentialVote;
      ...
      const { senadorId, diputadoId } = vote as unknown as CongressionalVote;
      ...
      const { alcalde, regidores } = vote as unknown as MunicipalVote;
